...
1) 피보험자명·보험나이·성별·계약자명 추출
2) 나이 → 유형 판단: A(0-15) B(16-24) C(25-34) D(35-49) E(50-64) F(65-74) G(75+)
...
```json
{
  ...
  "totalPages": 15,
  "customer": { "name":"{명}", "age":{나이}, "gender":"{남|여}", "contractor":"{계약자명}" },
